...
var Buttons = (function (_React$Component) {
    ...
    function Buttons() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Buttons)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.getButtonStyle = function (bsStyle) {
            var borderColor = '';
            var shadowColor = '';
            switch (bsStyle) {
                case 'primary':
